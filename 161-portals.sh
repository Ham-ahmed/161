...
wget --show-progress -qO /etc/enigma2/MultiStalkerPro.json "https://raw.githubusercontent.com/Ham-ahmed/161/refs/heads/main/MultiStalkerPro.json"
download=$?
echo ''
...
config.plugins.MultiStalkerPro.host=http://sansat.cc:88/
config.plugins.MultiStalkerPro.username=02055508512445
config.plugins.MultiStalkerPro.password=LadTSwazxzKUPVA
